			...
			<div class="col-xs-12">
				<div class="panel panel-default">
					<div class="panel-body">
						<form id="label_update_form" method="post" class="form-horizontal">
						    <input type="hidden" name="label.id" value="${label.id}">
						  	<div class="form-group">
						    	<label class="control-label col-xs-2">标签编号 <font color="red">*</font></label>
						    	<div class="col-xs-4"><input type="text" id="label_code" name="label.label_code" value="${label.label_code}" placeholder="如：10001" class="form-control"/></div>
						  	...
						  	<div class="form-group">
						    	...
						    	<div class="col-xs-4"><input type="text" id="label_name" name="label.label_name" value="${label.label_name}" placeholder="如：放款快" class="form-control"/></div>
						  	...
						  	<div class="form-group">
						    	...
						    	<div class="col-xs-4"><input type="text" id="remark" name="label.remark" value="${label.remark}" placeholder="如：放款快" class="form-control"/></div>
  ...
  <script type="text/javascript">
   $(document).ready(function() {
		...
		$("#labelpath").fileinput({
		      ...
		      initialPreview : "<img src='${label.label_path}' class='file-preview-image' />",
	...
	function form_save(){
		...
		$.ajax({
			url : "/label/labelUpdateInvoke",
			method : "post",
			data :  $("#label_update_form").serialize(),
			beforeSend : function() {
				$('.img_loading').show();
