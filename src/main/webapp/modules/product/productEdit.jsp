						    ...
						    <input type="hidden" name="product.id" value="${product.id}">
						  	...
						  	<div class="form-group">
						    	...
						    	<div class="form-inline">
						    	 &nbsp;&nbsp;&nbsp;
						    	   <input type="text" id="product_limit" name="product.product_limit" value="${product.product_limit}" placeholder="如：30000" class="form-control"/>万元
						    	</div>
						    </div>
						  	<div class="form-group">
  ...
  <script type="text/javascript">
   $(document).ready(function() {
	   var productType = "${product.product_type}";
	    ...
	    var labels = "${labels}";
	    var rules = "${rules}";
        var periods = "${product.product_period}";
	    $("#product_type").ui_select({schema:"ProductType",needDefault:false,selectedValue:productType.split(",")});
	    ...
	    $("#rule_id").ui_select({schema:"Rule",needDefault:false,selectedValue:rules.split(",")});
	    $("#product_period").ui_select({schema:"ProductPeriod",needDefault:false,selectedValue:periods.split(",")});
	   ...
	   var interests = "${product.interest_way}";
		...
		interestsarr.forEach(function(e){ 
			$("input[name='product.interest_way']:checkbox").each(function(){ 
				var value = $(this).val();
				if(e == value){
