 ...
 <div class="container-fluid">
			...
			<div class="col-xs-12">
				<div class="panel panel-default">
					<div class="panel-body">
						<form id="logcollect_add_form" method="post" class="form-horizontal">
						  	<div class="form-group">
						    	<label class="control-label col-xs-2">采集任务名称 <font color="red">*</font></label>
						    	<div class="col-xs-4"><input type="text" id="collect_name" name="logCollect.collect_name" placeholder="如：数据治理访问日志采集" class="form-control"/></div>
 						  	</div>
						  	<div class="form-group">
						  		<label class="control-label col-xs-2">es索引 <font color="red">*</font></label>
						    	<div class="col-xs-4"><input type="text" id="collect_es_index" name="logCollect.collect_es_index" placeholder="如：access-log" class="form-control"/></div>
 						  	</div>
 						  	<div class="form-group">
						  		<label class="control-label col-xs-2">es类型<font color="red">*</font></label>
						    	<div class="col-xs-4"><input type="text" id="collect_es_type" name="logCollect.collect_es_type" placeholder="如：access-log" class="form-control"/></div>
 						  	</div>
 						  	<div class="form-group">
  ...
  <script type="text/javascript">
	$(document).ready(function() {
		$("#status").ui_select({schema:"CollectStatus",needDefault:false,selectedValue:[]})
		$("#src_id").ui_select({schema:"LogSourceInfo",needDefault:false,selectedValue:[]})
		$("#machine_id").ui_select({schema:"LogCollectMachine",needDefault:false,selectedValue:[]})
	});
	...
	function form_save(){
		$.ajax({
			url : "/log/logcollect/logCollectSaveInvoke",
			method : "post",
			data :  $("#logcollect_add_form").serialize(),
			beforeSend : function() {
				$('.img_loading').show();
