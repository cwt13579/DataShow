...
<html lang="en">
 ...
 <div class="container-fluid">
        <div class="row page-header">
			<div class="col-xs-3">
				<h4><span class="glyphicon glyphicon-th"></span> 新增日志源</h4>
			</div>
		...
		<div class="row">
			<div class="col-xs-12">
		  	 <form id="logsourceinfo_add_form" method="post" class="form-horizontal">
	                  ...
	                  <div id="myTabContent" class="tab-content" style="padding-top:20px">
	                     <div class="tab-pane fade in active" id="base">
	                        <div class="form-group">
						    	...
						    	<div class="col-xs-4"><input type="text" id="src_name" name="logSourceInfo.src_name" placeholder="如：数据治理访问日志" class="form-control"/></div>
 						  	</div>
						  	<div class="form-group">
	                     ...
	                     <div class="tab-pane fade" id="extend">
	                       <div id="db">
	                        <div class="form-group">
						    	...
						    	<div class="col-xs-4"><input type="text" id="src_ip" name="logSourceInfo.src_ip" placeholder="如：192.168.3.253" class="form-control"/></div>
 						  	</div>
 						  	 <div class="form-group">
						  		<label class="control-label col-xs-2">端口<font color="red">*</font></label>
						    	<div class="col-xs-4"><input type="text" id="src_port" name="logSourceInfo.src_port" placeholder="如：8890" class="form-control"/></div>
 						  	</div>
 						  	<div class="form-group">
						  		<label class="control-label col-xs-2">用户名<font color="red">*</font></label>
						    	<div class="col-xs-4"><input type="text" id="src_user" name="logSourceInfo.src_user" placeholder="如：zy" class="form-control"/></div>
 						  	</div>
 						  	<div class="form-group">
						  		<label class="control-label col-xs-2">密码<font color="red">*</font></label>
						    	<div class="col-xs-4"><input type="text" id="src_pass" name="logSourceInfo.src_pass" placeholder="如：123" class="form-control"/></div>
 						  	</div>
 						  	<div class="form-group">
						  		<label class="control-label col-xs-2">sql<font color="red">*</font></label>
						    	<div class="col-xs-4"><input type="text" id="src_sql" name="logSourceInfo.src_sql" placeholder="如：select * from visit" class="form-control"/></div>
 						  	</div>
 						  </div>
 						  <div id="file">
 						  	...
 						  	<div class="form-group">
						    	...
						    	<div class="col-xs-4"><input type="text" id="src_path" name="logSourceInfo.src_path" placeholder="如：/opt/log/access-log" class="form-control"/></div>
 						  	</div>
 						  	<div class="form-group">
						  		<label class="control-label col-xs-2">分隔符<font color="red">*</font></label>
						    	<div class="col-xs-4"><input type="text" id="src_separator" name="logSourceInfo.src_separator" placeholder="如：," class="form-control"/></div>
 						  	</div>
 						  	<div class="form-group">
						  		<label class="control-label col-xs-2">正则表达式<font color="red">*</font></label>
						    	<div class="col-xs-4"><input type="text" id="src_regex" name="logSourceInfo.src_regex" placeholder="如：[a-zA-Z]" class="form-control"/></div>
 						  	</div>
 						 </div>
	                     <div id="syslog">
	                         <div class="form-group">
  ...
  <script type="text/javascript">
	$(document).ready(function() {
	    $("#src_type").ui_select({schema:"LogType",needDefault:true,defaultLabel:"请选择",selectedValue:[]})
	    $("#db").hide();
		$("#file").hide();
		$("#syslog").hide();
	});
	...
	function form_save(){
		$.ajax({
			url : "/log/logsourceinfo/logSourceInfoSaveInvoke",
			method : "post",
			data :  $("#logsourceinfo_add_form").serialize(),
			beforeSend : function() {
				$('.img_loading').show();
