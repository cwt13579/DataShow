...
<html lang="en">
 ...
 <div class="container-fluid">
        <div class="row page-header">
			<div class="col-xs-3">
				<h4><span class="glyphicon glyphicon-th"></span> 新增采集服务</h4>
			</div>
			...
			<div class="col-xs-12">
				<div class="panel panel-default">
					<div class="panel-body">
						<form id="logcollectmachine_add_form" method="post" class="form-horizontal">
						  	<div class="form-group">
						    	<label class="control-label col-xs-2">服务名称 <font color="red">*</font></label>
						    	<div class="col-xs-4"><input type="text" id="machine_name" name="logCollectMachine.machine_name" placeholder="如：logstash采集服务1" class="form-control"/></div>
 						  	</div>
						  	<div class="form-group">
						  		<label class="control-label col-xs-2">服务IP <font color="red">*</font></label>
						    	<div class="col-xs-4"><input type="text" id="machine_ip" name="logCollectMachine.machine_ip" placeholder="如：192.168.3.253" class="form-control"/></div>
 						  	</div>
 						  	<div class="form-group">
						  		<label class="control-label col-xs-2">服务安装路径<font color="red">*</font></label>
						    	<div class="col-xs-4"><input type="text" id="service_path" name="logCollectMachine.service_path" placeholder="如：21" class="form-control"/></div>
 						  	</div>
  ...
  <script type="text/javascript">
	...
	function form_cancel(){
		window.location = '/log/logCollectMachine/logCollectMachineList?keep=1';
	}

	function form_save(){
		$.ajax({
			url : "/log/logCollectMachine/logCollectMachineSaveInvoke",
			method : "post",
			data :  $("#logcollectmachine_add_form").serialize(),
			beforeSend : function() {
				$('.img_loading').show();
