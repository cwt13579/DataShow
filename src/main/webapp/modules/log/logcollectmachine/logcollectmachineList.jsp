...
<html lang="en">
 ...
 <div class="container-fluid">
        <div class="row page-header">
			<div class="col-xs-3">
				<h4><span class="glyphicon glyphicon-th"></span> 采集服务管理</h4>
			</div>
            <div class="col-xs-9" style="text-align: right; padding-right: 0px;">
				<button type="button" class="btn btn-default btn_loading" onclick="addLogCollectMachine()"><span class="glyphicon glyphicon-plus"></span>新增</button>
			</div>
		</div>
		<div class="row">
				<div class="col-xs-12">
							...
							<form id="search_form" method="post" class="form-inline">
								<div class="form-group">
									<label>名称</label> <input type="text" class="form-control"
										id="mechineName" name="qm.mechine_name"></input>
								</div>
  ...
  <script id="listScript" type="text/html">
		...
		<tr>
            ...
            <td>
                <a href="#" onclick="editLogCollectMachine('{{item.machine_id}}')"><span class="glyphicon glyphicon-edit"></span> 修改</a>
				<a href="#" onclick="deleteLogCollectMachine({{item.machine_id}})"><span class="glyphicon glyphicon-trash"></span> 删除</a>
			</td>
		</tr>
		{{/each}}
	</script>
  ...
  <script type="text/javascript">
    ...
    function getData(index) {
	    $.ajax({
			url: "/log/logCollectMachine/logCollectMachineListInvoke?current=" + index,
			method:"post",
    ...
    function addLogCollectMachine() {
    	window.location="/log/logCollectMachine/logCollectMachineAdd";
    }
    function editLogCollectMachine(id) {
    	window.location = '/log/logCollectMachine/logCollectMachineEdit?id=' + id;
    }
    function deleteLogCollectMachine(id) {
    	layer.confirm('删除确认', '', function() {
    	  $.ajax({
    		url:"/log/logCollectMachine/logCollectMachineDeleteInvoke?id=" + id,
    		method : "post",
            beforeSend : function() {
    		},
