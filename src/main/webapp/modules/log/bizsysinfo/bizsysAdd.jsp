...
<html lang="en">
 ...
 <div class="container-fluid">
        <div class="row page-header">
			<div class="col-xs-3">
				<h4><span class="glyphicon glyphicon-th"></span> 新增业务系统</h4>
			</div>
			...
			<div class="col-xs-12">
				<div class="panel panel-default">
					<div class="panel-body">
						<form id="bizsys_add_form" method="post" class="form-horizontal">
						  	<div class="form-group">
						    	<label class="control-bizSysInfo col-xs-2">系统名称 <font color="red">*</font></label>
						    	<div class="col-xs-4"><input type="text" id="sys_name" name="bizSysInfo.sys_name" placeholder="如：研究生教务" class="form-control"/></div>
 						  	</div>
						  	<div class="form-group">
						  		<label class="control-bizSysInfo col-xs-2">系统ip <font color="red">*</font></label>
						    	<div class="col-xs-4"><input type="text" id="sys_ip" name="bizSysInfo.sys_ip" placeholder="如：192.168.1.234" class="form-control"/></div>
 						  	</div>
 						  	<div class="form-group">
						  		<label class="control-bizSysInfo col-xs-2">系统简介<font color="red">*</font></label>
						    	<div class="col-xs-4"><input type="text" id="sys_info" name="bizSysInfo.sys_info" placeholder="如：研究生教务系统" class="form-control"/></div>
 						  	</div>
  ...
  <script type="text/javascript">
	...
	function form_save(){
		$("bizSysInfo.validate_bizSysInfo").text("");
		$.ajax({
			url : "/log/bizsys/bizSysInfoSaveInvoke",
			method : "post",
			data :  $("#bizsys_add_form").serialize(),
			beforeSend : function() {
				$('.img_loading').show();
