...
<html lang="en">
 ...
 <div class="container-fluid">
        <div class="row page-header">
			<div class="col-xs-3">
				<h4><span class="glyphicon glyphicon-th"></span> 机构管理</h4>
			</div>
		...
		<div class="row">
					...
					<div class="panel panel-default">
						...
						<div class="col-xs-9">
							<form id="search_form" method="post" class="form-inline">
									...
									<input type="hidden" class="form-control"
										id="dataType" name="qm.data_type" value="Org"></input>
								
								<div class="form-group">
									<label>机构名称</label> <input type="text" class="form-control"
										id="dataName" name="qm.data_name"></input>
								</div>
						...
						<div class="col-xs-3" style="text-align: right; padding-right: 0px;">
						  <a class="btn btn-default btn_loading" href="/template/org.xls"><span  class="glyphicon glyphicon-download">导入模板</span></a>
  ...
  <script id="listScript" type="text/html">
		...
		<%@ include file="/modules/statisticsrecord/orgUploadModel.jsp"%>
</body>
  ...
  <script type="text/javascript">
    ...
    function getData(index) {
	    $.ajax({
			url: "/statisticsRecord/orgListInvoke?current=" + index,
			method:"post",
