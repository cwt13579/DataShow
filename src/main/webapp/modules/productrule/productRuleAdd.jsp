					...
					<div class="panel-body">
						<form id="productrule_add_form" method="post" class="form-horizontal">
						  	<div class="form-group">
						    	...
						    	<div class="col-xs-4"><input type="text" id="product_code" name="productRule.product_code" placeholder="如：10001" class="form-control"/></div>
						  	...
						  	<div class="form-group">
						    	...
						    	<div class="col-xs-4"><input type="text" id="product_name" name="productRule.product_name" placeholder="如：财富宝" class="form-control"/></div>
						  	...
						  	<div class="form-group">
						    	...
						    	<div class="col-xs-4"><input type="text" id="loan_amount" name="productRule.loan_amount" placeholder="如：30000" class="form-control"/></div>
						  	...
						  	<div class="form-group">
						    	...
						    	<div class="col-xs-2"><input type="text" id="loan_term" name="productRule.loan_term" placeholder="如：180" class="form-control"/></div>
