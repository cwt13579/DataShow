...
<html lang="en">
 ...
 <div class="container-fluid">
        <div class="row page-header">
			<div class="col-xs-3">
				<h4><span class="glyphicon glyphicon-th"></span> 产品规则列表</h4>
			</div>
			<div class="col-xs-9" style="text-align: right; padding-right: 0px;">
				<button type="button" class="btn btn-default btn_loading" onclick="addProductRule()"><span class="glyphicon glyphicon-plus"></span>新增</button>
			</div>
		</div>
		<div class="row">
				<div class="col-xs-12">
  ...
  <script id="listScript" type="text/html">
		...
		<tr>
            ...
            <td>
                <a href="#" onclick="editProductRule({{item.id}})"><span class="glyphicon glyphicon-edit"></span> 修改</a>
				<a href="#" onclick="deleteProductRule({{item.id}})"><span class="glyphicon glyphicon-trash"></span> 删除</a>
			</td>
		</tr>
		{{/each}}
	</script>
  ...
  <script type="text/javascript">
    ...
    function addProductRule() {
    	window.location="/productRule/productRuleAdd";
    }
    function editProductRule(id) {
    	window.location = '/productRule/productRuleEdit?id=' + id;
    }
    function deleteProductRule(id) {
    	layer.confirm('删除确认', '', function() {
    	  $.ajax({
    		url:"/productRule/productRuleDeleteInvoke?id=" + id,
    		method : "post",
            beforeSend : function() {
    		},
