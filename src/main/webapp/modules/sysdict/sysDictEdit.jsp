 ...
 <div class="container-fluid">
			...
			<div class="col-xs-12">
				<div class="panel panel-default">
					<div class="panel-body">
						<form id="sysDict_update_form" method="post" class="form-horizontal">
							<input type="hidden" name="sysDict.id" value="${sysDict.id}">
						  	<div class="form-group">
						    	...
						    	<div class="col-xs-4"><input type="text" id="data_type" name="sysDict.data_type" value="${sysDict.data_type}" placeholder="如：DataStatus" class="form-control"/></div>
 						  	</div>
						  	<div class="form-group">
						  		<label class="control-sysDict col-xs-2">数据字典值 <font color="red">*</font></label>
						    	<div class="col-xs-4"><input type="text" id="data_value" name="sysDict.data_value" value="${sysDict.data_value}" placeholder="如：1" class="form-control"/></div>
 						  	</div>
 						  	<div class="form-group">
						  		<label class="control-sysDict col-xs-2">数据字名称<font color="red">*</font></label>
						    	<div class="col-xs-4"><input type="text" id="data_name" name="sysDict.data_name" value="${sysDict.data_name}" placeholder="如：是" class="form-control"/></div>
 						  	</div>
 						  	<div class="form-group">
						  		<label class="control-sysDict col-xs-2">备注<font color="red">*</font></label>
						    	<div class="col-xs-4"><input type="text" id="remark" name="sysDict.remark" value="${sysDict.remark}" placeholder="如：信贷审批状态" class="form-control"/></div>
 						  	</div>
 						  	<div class="form-group">
  ...
  <script type="text/javascript">
	...
	function form_save(){
		...
		$.ajax({
			url : "/sysDict/sysDictUpdateInvoke",
			method : "post",
			data :  $("#sysDict_update_form").serialize(),
			beforeSend : function() {
				$('.img_loading').show();
