    ...
    $.widget("primeui.puiaccordion", {
        ...
        _create: function() {
            if(this.options.multiple) {
                ...
                if(!this.options.activeIndex||!this.options.activeIndex.length){
            ...
            this.element.children('h3').addClass('pui-accordion-header ui-helper-reset ui-state-default').each(function(i) {
                ...
                if($this.options.multiple) {
                	headerClass='ui-corner-all';
                	iconClass='ui-icon ui-icon-triangle-1-e';
                	for(var j=0;j<$this.options.activeIndex.length;j++){
                		if(i==$this.options.activeIndex[j]){
                			headerClass='ui-state-active ui-corner-top';
                        	iconClass='ui-icon ui-icon-triangle-1-s';
                		}
                	}
                }else{              	
