...
$(function() {
    ...
    $.widget("primeui.puibutton", {
        ...
        _create: function() {
            ...
            this.element.addClass('pui-button ui-widget ui-state-default ui-corner-all ' + styleClass);
            ...
            /**
             * ie8下input，button等标签不允许有子标签，另外下面这句话对界面显示美人和影响
             */
//            this.element.append('<span class="pui-button-text">' + text + '</span>');
            ...
            if(LT.simpleStyle){
            	element.addClass("lt_simpleStyle_background").removeClass('ui-corner-all').css("border-radius","3px");
            }
        },
