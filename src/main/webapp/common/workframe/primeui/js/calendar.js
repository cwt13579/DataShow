...
Calendar.language = {
	...
	"date2StringPattern" : ["yyyyMMdd", "yyyyMMdd", "yyyyMMdd", "yyyyMMdd"],
...
//	alert($(popuControl).offset().top)
	var pos=$(popuControl).offset();
	pos.top=pos.top+$(popuControl).height()+4;
	pos.left=pos.left+($(popuControl).width()-$(this.panel).width())/2
	$(this.panel).css(pos);
...
Calendar.prototype.hide = function() {
	$(this.dateControl).trigger("change");
...
String.prototype.toDate = function(delimiter, pattern) {
	...
	if(delimiter==""){
		a=[this.substring(0, 4),this.substring(4, 6),this.substring(6, 8)];
	}
...
//$("#__calendarPanel").hover(function(evt){
//	evt=evt||window.event;
//	if(evt.type!="mouseenter"){
//		$("#__calendarPanel").hide();
//	}
//});
//document.getElementById("__calendarPanel").onmouseover=function(){
//	alert(1)
//};
