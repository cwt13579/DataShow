...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		var eg = $("<div class='ui-jqgrid ui-widget ui-widget-content ui-corner-all box-shadow'></div>");
		...
		setPager = function (pgid, tp){
			...
			if(ts.p.pgbuttons===true) {
				...
				pgl += "<td id='"+po[3]+"' class='ui-pg-button ui-corner-all'><span class=' ui-icon-seek-end'>末页</span></td>";
